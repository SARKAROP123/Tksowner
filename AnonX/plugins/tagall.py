...
TAGSRT = [ " **𝐇𝐞𝐲 𝐁𝐚𝐛𝐲 𝐊𝐚𝐡𝐚 𝐇𝐨🥱** ",
           ...
           " **𝐀𝐚𝐩𝐤𝐨 𝐆𝐚𝐧𝐚 𝐆𝐚𝐧𝐞 𝐀𝐚𝐭𝐚 𝐇𝐚𝐢𝐧 𝐓𝐨 𝐒𝐮𝐧𝐚 𝐝𝐨 𝐯𝐜 @TKS_JOIN..?😸** ",
           " **𝐆𝐡𝐮𝐦𝐧𝐞 𝐂𝐡𝐚𝐥𝐨𝐠𝐞..??🙈** ",
           " **𝐊𝐡𝐮𝐬 𝐑𝐚𝐡𝐚 𝐊𝐚𝐫𝐨 ✌️🤞** ",
           ...
           " **𝐌𝐲 𝐂𝐮𝐭𝐞 𝐎𝐰𝐧𝐞𝐫 [ @ll_SARKAR_BABY_ll]🥰** ",
           " **𝐘𝐞𝐡 𝐁𝐨𝐭 𝐀𝐩𝐤𝐞 𝐆𝐫𝐨𝐮𝐩 𝐌𝐞 𝐀𝐝𝐝 𝐊𝐫𝐝𝐨🥲 [ @ll_RADHA_MUSICBOT ]😇** ",
           " **𝐊𝐚𝐡𝐚 𝐊𝐡𝐨𝐲𝐞 𝐇𝐨 𝐉𝐚𝐚𝐧😜** ",
           " **𝐆𝐨𝐨𝐝 𝐍8 𝐉𝐢 𝐁𝐡𝐮𝐭 𝐑𝐚𝐭 𝐇𝐨 𝐠𝐲𝐢🥰** ",
           ]

@app.on_message(filters.command(["utag", "eftag", "tagmember"], prefixes=["/", "@", "#"]))
async def mentionall(client, message):
    ...
    if message.reply_to_message and message.text:
        ...
        if not msg:
            return await message.reply("/utag hii 👈 Try this or reply any message...")
    else:
